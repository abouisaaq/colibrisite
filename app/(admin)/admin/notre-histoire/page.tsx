        ...
        media={{
          ...
          terrain: {
            photos: {
              ...
              photo4: settings[STORY_TERRAIN_SETTING_KEYS.photo4] ?? "",
              photo5: settings[STORY_TERRAIN_SETTING_KEYS.photo5] ?? "",
              photo6: settings[STORY_TERRAIN_SETTING_KEYS.photo6] ?? "",
              photo7: settings[STORY_TERRAIN_SETTING_KEYS.photo7] ?? "",
            },
            ...
            video2Url: settings[STORY_TERRAIN_SETTING_KEYS.video2File],
            video2PosterUrl: settings[STORY_TERRAIN_SETTING_KEYS.video2Poster],
            youtubeUrl2: settings[STORY_TERRAIN_SETTING_KEYS.youtubeUrl2],
          },
          accompagnement: {
